...
-- Volcando datos para la tabla tienda_carlos_picado_esteban.detalles_pedido: ~15 rows (aproximadamente)
...
-- Volcando datos para la tabla tienda_carlos_picado_esteban.opciones_menu: ~18 rows (aproximadamente)
...
-- Volcando datos para la tabla tienda_carlos_picado_esteban.pedidos: ~6 rows (aproximadamente)
...
INSERT INTO `pedidos` (`id`, `id_usuario`, `fecha`, `metodo_pago`, `estado`, `num_factura`, `total`) VALUES
	...
	(7, 40, '2022-11-10 13:02:53', 'Transferencia Bancaria', 'E', 'A0', 34499.6),
...
-- Volcando datos para la tabla tienda_carlos_picado_esteban.productos: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `productos` DISABLE KEYS */;
INSERT INTO `productos` (`id`, `id_categoria`, `nombre`, `descripcion`, `precio`, `stock`, `impuesto`, `imagen`, `baja`, `fecha_alta`) VALUES
	(1, 1, 'Traje de seda Armani H', 'Traje de hombre', 1854.45, 50, 21, '1', 0, '2022-11-10 14:38:58'),
	(2, 1, 'Traje de Ka\'Lium', 'Traje de mujer', 2458.00, 50, 21, '2', 0, '2022-11-10 14:38:59'),
	(3, 2, 'Calcetines WinniePooh', 'Calcetines de talla pequeña', 1.76, 25, 21, '3', 1, '2022-11-10 14:39:00'),
	(4, 4, 'Pantalones de Rosa Mosqueta', 'Pantalones de color rojo ideal para bodas', 568.00, 14, 21, '4', 0, '2022-11-10 14:39:01'),
	(5, 5, 'Camisa de trazas a la moda', 'Complemento imprenscindible para los niños', 125.99, 21, 21, '5', 1, '2022-11-10 14:39:05'),
	(9, 5, 'Camisa de franela para jóven', 'Color rojo con cuadros negros', 21.75, 19, 21, '9', 0, '2022-11-10 14:39:08'),
	(10, 6, 'Camiseta de deporte', 'Una camiseta muy cómoda para hacer deporte', 9.75, 0, 21, '10', 0, '2022-11-10 14:39:09');
